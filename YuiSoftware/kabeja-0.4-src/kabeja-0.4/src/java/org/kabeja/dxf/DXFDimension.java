...
public class DXFDimension extends DXFEntity {
	...
	public void setDimlfac(double dimlfac) {
        if(this.dimlfac == 1) this.dimlfac = dimlfac;
    }
	
	public double getDimlfac() {
        return dimlfac;
    }
