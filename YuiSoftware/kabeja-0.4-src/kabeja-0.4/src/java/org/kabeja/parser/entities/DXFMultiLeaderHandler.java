...
import org.kabeja.dxf.DXFMultiLeader; // file with class if entity MultiLeader
 ...
 *
 */
public class DXFMultiLeaderHandler extends AbstractEntityHandler {
	public static final int GROUPCODE_FRAME_TEXT = 292; // enable frame text
	public static final int GROUPCODE_ATTACHMENT_TEXT = 171; // attachmend of text
	public static final int GROUPCODE_TEXT = 304; // text of multileader
    ...
    public static final int GROUPCODE_TEXT_HEIGHT = 41; // size of font
    public static final int GROUPCODE_COLOR_LEADER = 77;
    public static final int GROUPCODE_TEXT_ENTITY_REFERENCE = 340;
	public static final int GROUPCODE_TEXT_LOCATION_X = 12; // text insert point (top center point)
	public static final int GROUPCODE_TEXT_LOCATION_Y = 22;
	public static final int GROUPCODE_TEXT_LOCATION_Z = 32;
    ...
    protected DXFMultiLeader leader;
    ...
    public String getDXFEntityName() {
        return DXFConstants.ENTITY_TYPE_MULTILEADER; // "MULTILEADER" from DXFConstants
    }
    ...
    public void parseGroup(int groupCode, DXFValue value) {
        switch (groupCode) {
		case GROUPCODE_FRAME_TEXT: // enable frame text
			leader.setFrameEnabled(!value.getBooleanValue());
			break;
			
		case GROUPCODE_TEXT_LOCATION_X: // parse point of text insertion
			leader.getTextLocation().setX(value.getDoubleValue());
			break;
			
		case GROUPCODE_TEXT_LOCATION_Y:
			leader.getTextLocation().setY(value.getDoubleValue());
			break;
			
		case GROUPCODE_TEXT_LOCATION_Z:
			leader.getTextLocation().setZ(value.getDoubleValue());
			break;
			
		case GROUPCODE_ATTACHMENT_TEXT: // parsing attachment of text
			leader.setAttachmentText(value.getIntegerValue());
			break;
			
		case GROUPCODE_TEXT:
			leader.setText(value.getValue());
			break;
