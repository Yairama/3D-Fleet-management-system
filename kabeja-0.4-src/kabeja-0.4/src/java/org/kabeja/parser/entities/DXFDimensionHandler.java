/** \file
 * I added parsing DIMLFAC. Its first 1040 value
 *
 * Type: Java code 
...
public class DXFDimensionHandler extends AbstractEntityHandler {
	protected final static int GROUPCODE_DIMLFAC = 1040;
    ...
    public void parseGroup(int groupCode, DXFValue value) {
        switch (groupCode) {
		case GROUPCODE_DIMLFAC:
			dimension.setDimlfac(value.getDoubleValue());
			break;
